...
class CodeGen {
  ...
  static void gen(IR1.Func n) throws Exception { 
    ...
    for(int i = 0; i < n.params.length; ++i){
        X86.Reg register = X86.resize_reg(X86.Size.L, X86.allRegs[i]);
        X86.emit2("movl", register, new X86.Mem(X86.RSP, i*4)); 
    }
...
/*    int register = 5;
    for (int i=0; i < n.params.length; i++) {
      if (register == 1)
        ...
        X86.emit2("movl", new X86.Reg(register , X86.Size.L), new X86.Mem(X86.RSP, i*4)); 
      register--;
    }
*/
    // emit code for the body
  ...
  static void gen(IR1.Binop n) throws Exception {
    ...
    if (n.op instanceof IR1.AOP) {
      ...
      if (n.op == IR1.AOP.DIV) {
            ...
            X86.emit2("movl", X86.EAX, new X86.Mem(X86.RSP, index*4)); 
	}
        else {
            ...
            X86.emit2("movl", new X86.Reg(10 , X86.Size.L), new X86.Mem(X86.RSP, index*4)); 
        }
    }
        ...
        switch ((IR1.ROP) n.op) {
              ...
              case GE: X86.emit1("setge", new X86.Reg(10, X86.Size.B)); break;
              case LT: X86.emit1("setl", new X86.Reg(10, X86.Size.B)); break;
              case LE: X86.emit1("setle", new X86.Reg(10, X86.Size.B)); break;
              case EQ: X86.emit1("sete", new X86.Reg(10, X86.Size.B)); break;
              case NE: X86.emit1("setne", new X86.Reg(10, X86.Size.B)); break;
        }
        //X86.Reg register = X86.resize_reg(X86.Size.B, tempReg1);
	//X86.emit2("movzbl", register, new X86.Reg(10, X86.Size.L));
  ...
  static void gen(IR1.Load n) throws Exception {
    ...
    X86.emit2("movl", new X86.Reg(11 , X86.Size.L), new X86.Mem(X86.RSP, index*4)); 
  ...
  static void gen(IR1.Store n) throws Exception {
    ...
    // emit a mov
    X86.emit2("movl", new X86.Reg(10 , X86.Size.L), addr); 
  }
  ...
  static void gen(IR1.Call n) throws Exception {
    ...
    for (int i=0; i < n.args.length; i++) {
      if (register == 1)
        ...
        to_reg(n.args[i], new X86.Reg(register)); 
      register--;
    }
    ...
    if (n.rdst != null) {
        ...
        if (!allVars.contains(varName))
            allVars.add(varName);
        int index = allVars.indexOf(n.rdst.toString());
        X86.emit2("movl", X86.EAX, new X86.Mem(X86.RSP, index*4));
    }
  }
